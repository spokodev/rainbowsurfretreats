...
const defaultHeaderImage = { url: RETREAT_IMAGES.morocco, alt: 'Our Retreats' }

export default function RetreatsPageClient({ initialRetreats, headerImage }: RetreatsPageClientProps) {
