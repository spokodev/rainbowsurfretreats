                      ...
                      <div className="flex justify-between items-center mt-3">
                        ...
                        {!room.is_sold_out && room.available > 0 ? (
                          <div className="flex items-center gap-3">
                            ...
                            <Button asChild size="sm" className="bg-[var(--primary-teal)] text-[var(--earth-brown)] hover:bg-[var(--primary-teal-hover)]">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            className="border-[var(--primary-teal-dark)] text-[var(--earth-brown)] hover:bg-[var(--primary-teal-light)]"
